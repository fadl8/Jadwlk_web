        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="heading-elements">
                    <a href="?page=dataTableFill&Id=<?php echo $_GET['Id'] ?>" style="padding: 5px;" class="btn mr-1 btn-outline-primary btn-sm">تعبية</a>
                </div>
            </div>
                        ...
                        <tr>
                            ...
                            for ($i=0; $i < count($tableColumn) ; $i++) {
                                ...
                                echo "<th style='".$stylecolumn."'> 
                                            <div class='".$tableStyle["cellstyle"]."' style='".$CloumnSheepstyle."'>
                                                <span style='text-align:left'>" . $tableColumn[$i]['columnName'] . "</span>
                                            </div>
                                        </th>";
                            }
                            ?>
                                ...
                                for ($i=1; $i <= $tableInfo['rowCount'] ; $i++) {
                                   ...
                                   echo "<tr style='border-width: 8px;'>
                                                ...
                                                <div class='".$tableStyle["cellstyle"]."' style='".$RowSheepstyle."'> 
                                                    <span style='text-align:left;'>المحتوى</span> 
                                                </div>
                                            </td>

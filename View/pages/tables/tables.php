                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="heading-elements">
                                <a href="?page=Add" style="padding: 5px;" class="btn mr-1 btn-outline-primary btn-sm">اضافه جدول</a>
                            </div>
                        </div>
                        <div class="card-body collapse in">
                            <div class="table-responsive">
                                <table class="table table-hover mb-0">
                                    ...
                                    <tbody>
                                    <tr>
                                    <?php foreach( Action::RetrieveData('tables') as $table ){ ?>
                                        ...
                                        <th>
                                            <!-- <a href="?page=EditTable&Id=<?php // echo $table['Id']; ?>"  class="btn  btn-outline-info btn-sm">تعديل</a> -->
                                            <a href="?page=Viewpage&Id=<?php echo $table['Id']; ?>"   class="btn  btn-outline-primary btn-sm">عرض </a>
                                            <button type="button"  data-toggle='modal' data-target='#<?php echo $ModeldeleteId ;?>'  class="btn  btn-outline-danger btn-sm">حذف</button>
                                        </th>
                                    </tr>
